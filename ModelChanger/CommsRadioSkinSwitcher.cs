...
namespace ModelChanger
{
    public class CommsRadioSkinSwitcher : MonoBehaviour, ICommsRadioMode
    {
        ...
        {
            string content = "Aim at the vehicle you wish to remodel.";
            display.SetDisplay("REMODEL", content, "");
        }
        ...
        private void ApplySelectedSkin()
        {
            ...
            {
                Debug.LogWarning("Tried to remodel to null selection");
            }

            Main.trainCarState[SelectedCar.CarGUID] = SelectedSkin.name;
            HeadMarkUtils.CreateHeadMark(SelectedCar);
            Main.ReplaceHeadMarkTexture(SelectedCar);
        }
        ...
        private void SetSelectedSkin(Skin skin)
        {
            ...
            {
                SelectedSkin = null;
                display.SetContent("No available models!");
            }
            else
            {
                SelectedSkin = skin;
                string displayName = "Select Model:\n" + skin.name.Replace('_', ' ');
